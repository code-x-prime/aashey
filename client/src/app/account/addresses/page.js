        ...
        <div className="p-4 max-w-4xl mx-auto">
            ...
            {addresses.length === 0 && !showAddForm && !editingAddress ? (
                <div className="bg-white rounded-lg shadow p-8 text-center border">
                    <MapPin className="h-16 w-16 mx-auto text-[#7A4E2D] mb-4" />
                    <h2 className="text-xl font-semibold mb-2">No Addresses Found</h2>
                    <p className="text-[#5C3A1E] mb-6">You haven&apos;t added any addresses yet.</p>
                    ...
                    {addresses.map((address) => (
                        <div key={address.id} className="bg-white rounded-lg shadow p-5 border relative">
                            ...
                            <div className="mb-4">
                                ...
                                <p className="text-[#5C3A1E]">{address.street}</p>
                                <p className="text-[#5C3A1E]">{address.city}, {address.state} {address.postalCode}</p>
                                <p className="text-[#5C3A1E]">{address.country}</p>
                                <p className="text-[#5C3A1E] mt-1"><span className="font-medium">Phone:</span> {address.phone}</p>
                            </div>
