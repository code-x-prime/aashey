                    ...
                    <div className="bg-white rounded-2xl shadow-[0_4px_24px_rgba(63,31,0,0.08)] border border-[#C9933A]/15 p-3 md:p-6 sticky top-4 hover:shadow-lg transition-shadow duration-300">
                        ...
                        <div className="border-t-2 border-[#C9933A]/30 pt-5">
                            <div className="space-y-3 text-sm">
                                ...
                                {totals.shipping > 0 && getFreeShippingThreshold() > 0 && (
                                    <div className="mt-2 text-sm text-[#C9933A] bg-[#C9933A]/10 p-3 rounded-md text-center font-medium border border-[#C9933A]/20 flex items-center justify-center gap-2">
                                        ...
                                        <span>
                                            Add <strong>{formatCurrency(getFreeShippingThreshold() - totals.subtotal)}</strong> more for <span className="text-[#092D15] font-bold">FREE shipping!</span>
                                        </span>
                                    </div>
                                )}
