...
export async function generateMetadata({ params }) {
    const { slug } = params;
    let title = "Product Details | Aashey";
    let description =
        "Shop premium quality products at Aashey. Fast delivery, secure payments, and 100% genuine products.";
    let image = null;
    ...
    try {
        ...
        if (product) {
            title = product.metaTitle || `${product.name} | Aashey`;
            description =
