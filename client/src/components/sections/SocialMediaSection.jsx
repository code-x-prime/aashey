...
const socialLinks = [
  {
    name: "Instagram",
    handle: "@official_aashey",
    url: "https://www.instagram.com/official_aashey/",
    icon: Instagram,
  ...
  },
  {
    name: "YouTube",
    handle: "@@aashey",
    url: "https://youtube.com/@@aashey?si=ZkkCpU1DEh48NBSe",
    icon: Youtube,
    ...
    <section className="py-12 md:py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-2xl md:text-4xl font-bold text-[#1A0A00] mb-3">
            Follow Aashey
          </h2>
          <p className="text-[#5C3A1E] max-w-2xl mx-auto">
          ...
          {socialLinks.map((social, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                {/* Info */}
                <h3 className="text-xl font-bold text-[#1A0A00] group-hover:text-white transition-colors mb-1">
                  {social.name}
                </h3>
                <p className="text-primary group-hover:text-white/90 font-medium text-sm mb-2 transition-colors">
                  {social.handle}
                </p>
                <p className="text-[#6B4423] group-hover:text-white/80 text-sm transition-colors mb-4">
                  {social.description}
                </p>
        ...
        <div className="text-center mt-10">
          <p className="text-[#6B4423] text-sm mb-4">
            Join thousands of audio professionals following Aashey
          </p>
