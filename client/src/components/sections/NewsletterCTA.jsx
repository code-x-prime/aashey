      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[440px]">
        ...
        <div className="relative bg-[#3F1F00] flex flex-col items-start justify-center px-8 py-14 md:px-14 md:py-16 overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="font-sans text-4xl md:text-5xl font-bold text-[#FDF6E3] leading-[1.1] mb-4">
              Join Our <br />
        ...
        <div className="relative bg-white flex flex-col justify-center px-8 py-14 md:px-14 md:py-16">
          ...
          {isSuccess ? (
            <div className="flex flex-col items-center text-center py-6">
              ...
              <p className="font-sans font-bold text-[#3F1F00] text-3xl mb-2">
                {status === "already" ? "Already with us!" : "Welcome aboard! ðŸ™"}
              </p>
            ...
            <>
              ...
              <div className="mb-8">
                ...
                <h3 className="font-sans text-3xl font-bold text-[#3F1F00] leading-tight">
                  Stay in the loop
                </h3>
