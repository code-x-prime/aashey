    ...
    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div>
        ...
        <div className="relative">
          <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#6B4423]" />
          <input
            type="text"
            id="name"
            name="name"
      ...
      <div>
        ...
        <div className="relative">
          <Phone className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#6B4423]" />
          <input
            type="tel"
            id="phone"
            name="phone"
      ...
      <div>
        ...
        <div className="relative">
          <Mail className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#6B4423]" />
          <input
            type="email"
            id="email"
            name="email"
      ...
      {productName && (
        <div>
          ...
          <div className="relative">
            <Package className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[#6B4423]" />
            <input
              type="text"
              id="product"
              name="product"
              ...
              readOnly
              className="w-full pl-10 pr-4 py-2.5 border border-input rounded-lg bg-muted text-[#6B4423]"
            />
          </div>
        </div>
      )}
      ...
      <div className="md:col-span-2">
        ...
        <div className="relative">
          <MessageSquare className="absolute left-3 top-3 h-4 w-4 text-[#6B4423]" />
          <textarea
            id="message"
            name="message"
